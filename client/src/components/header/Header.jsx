...
import { HomeOutlined, ShoppingCartOutlined, CopyOutlined, UserOutlined, BarChartOutlined, LogoutOutlined } from "@ant-design/icons";
        ...
        <div className='border-b mb-6'>
            <header className='py-4 px-6 flex justify-between items-center gap-10'>
                ...
                <div className="header-search flex-1 justify-center">
                    <Input size="large" className="rounded-full max-w-[900px]" placeholder="Ürün Ara..." prefix={<SearchOutlined />} />
                </div>
