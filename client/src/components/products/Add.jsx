    ...
    return (
        <Modal title="Yeni Ürün Ekle" open={isAddModalOpen} onCancel={() => setIsAddModalOpen(false)} footer={false}>
            <Form layout="vertical" onFinish={onFinish} form={form}>
                <Form.Item name="title" label="Ürün Adı" rules={[{ required: true, message: "Ürün Alanı Boş Geçilemez!" }]}>
                    <Input placeholder='Ürün adı giriniz...' />
                </Form.Item>
                <Form.Item name="img" label="Ürün Görseli" rules={[{ required: true, message: "Ürün Görseli Alanı Boş Geçilemez!" }]}>
                    <Input placeholder='Ürün görseli giriniz...' />
                </Form.Item>
                <Form.Item name="price" label="Ürün Fiyatı" rules={[{ required: true, message: "Ürün Fiyatı Boş Geçilemez!" }]}>
                    <Input placeholder='Ürün fiyatı giriniz...' />
                </Form.Item>
                <Form.Item name="category" label="Ürünün Kategorisini Seç" rules={[{ required: true, message: "Ürün Kategori Alanı Boş Geçilemez!" }]}>
                    <Select
                        showSearch
